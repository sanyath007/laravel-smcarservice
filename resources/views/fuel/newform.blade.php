    ...
    @section('content')
    <div class="container-fluid" ng-controller="fuelCtrl" ng-init="popUpAllVehicle()">
      
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/fuel/list') }}">หน้าหลัก</a></li>
            <li class="breadcrumb-item active">บันทึกการใช้น้ำมันเชื้อเพลิง</li>
        </ol>
        ...
        <form id="frmNewFuel" action="{{ url('/fuel/add') }}" method="post" enctype="multipart/form-data">
             <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="form-group" ng-class="{'has-error has-feedback': checkValidate('billDate')}">
                        ...
                        <input  type="text" id="bill_date" name="bill_date" 
                                ng-model="newFuel.billDate" class="form-control">
